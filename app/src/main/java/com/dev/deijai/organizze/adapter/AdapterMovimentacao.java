package com.dev.deijai.organizze.adapter;
...
public class AdapterMovimentacao extends RecyclerView.Adapter<AdapterMovimentacao.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.titulo.setTextColor(context.getResources().getColor(R.color.colorAccent));

        if (movimentacao.getTipo() == "d" || movimentacao.getTipo().equals("d")) {
            holder.valor.setTextColor(context.getResources().getColor(R.color.colorDes));
            holder.titulo.setTextColor(context.getResources().getColor(R.color.colorDes));
